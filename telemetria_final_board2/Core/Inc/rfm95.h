...
#define RFM95_RESET_PIN     GPIO_PIN_10
...
extern int flagLoRaGPS;
extern int flagLoRaIMUAttitude;
extern int flagLoRaCAN1Hz;
extern int flagLoRaCAN2Hz;
extern int flagLoRaSpeed;
extern int flagLoRaOil;
