...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(OIL_OUT_GPIO_Port, OIL_OUT_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(MAGNETIC_PWM3_GPIO_Port, MAGNETIC_PWM3_Pin);
  ...
  else if(htim_base->Instance==TIM3)
  {
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(MAGNETIC_PWM2_GPIO_Port, MAGNETIC_PWM2_Pin);
  ...
  else if(htim_base->Instance==TIM4)
  {
    ...
    PB6     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(SPEED_PWM_GPIO_Port, SPEED_PWM_Pin);
  ...
  else if(htim_base->Instance==TIM8)
  {
    ...
    PC6     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(MAGNETIC_PWM1_GPIO_Port, MAGNETIC_PWM1_Pin);
