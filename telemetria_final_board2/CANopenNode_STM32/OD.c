/*******************************************************************************
    ...
    This file was automatically generated by CANopenEditor v4.2.3-9-gd9ca4aa-dirty+d9ca4aa216ff553aaee5ac570825c16bc125457f
...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1017_producerHeartbeatTime = 0x0BB8,
    .x1018_identity = {
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_V_C = {
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.header,
            .subIndex = 1,
            .attribute = ODA_SDO_R | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val1,
            .subIndex = 2,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val2,
            .subIndex = 3,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val3,
            .subIndex = 4,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val4,
            .subIndex = 5,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val5,
            .subIndex = 6,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_PERSIST_COMM.x6000_V_C.val6,
            .subIndex = 7,
            .attribute = ODA_SDO_R | ODA_TPDO,
            .dataLength = 1
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x08, ODT_REC, &ODObjs.o_6000_V_C, NULL},
